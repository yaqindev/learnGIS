...
class Googlemaps {
	...
	// var $apiKey						= 'AIzaSyAJAKJyxcjStFrbTv1ftqRdfDZ3VxaK00A  ';// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	var $apiKey						= 'AIzaSyAM2BDXpFKZqPmWaZg2Uuisz1HLyzhEFgQ ';// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= "-7.598226, 112.784753";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	var $map_height					= "570px";					// The height of the map container. Any units (ie 'px') can be used. If no units are provided 'px' will be presumed
